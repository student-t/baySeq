setClass("densityFunction", representation(description = "character", density = "function", initiatingValues = "function", equalOverReplicates = "function", lower = "function", upper = "function", stratifyFunction = "function", stratifyBreaks = "numeric", nullFunction = "function", orderingFunction = "function"))
